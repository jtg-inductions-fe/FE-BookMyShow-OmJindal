...
- **Node.js**: Version 22.20+. You can download and install it from [nodejs.org](https://nodejs.org/).
...
2. **nvm (Node Version Manager)**: If the required Node version 22.20+ is already installed and active, you can skip this step else you can use nvm (Node Version Manager). Here's how to use it:
